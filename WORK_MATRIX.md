...
| Testing | Full regression run under current host load | [x] | Local `./test_c_subset_assembler.sh` passes; CI keeps deterministic fixture gates because capability probes vary by runner |
