...
struct Stmt{using N=std::variant<ReturnStmt,ExprStmt,IfStmt,WhileStmt,ForStmt,BreakStmt,ContinueStmt>;N n;template<class X>Stmt(X x):n(std::move(x)){} };
