...
struct E{using N=std::variant<Lit,Var,Addr,Deref,Member,Arrow,Binary,Assign,If,While,Sequence,Index,Sizeof,Call,FunctionRef,IndirectCall>;N n;template<class X>E(X x):n(std::move(x)){} };
