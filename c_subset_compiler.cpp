...
bool emit_msgsnd_query_mode = false;
bool emit_msgrcv_query_mode = false;
bool emit_msgctl_query_mode = false;
bool emit_mq_open_query_mode = false;
bool emit_mq_unlink_query_mode = false;
...
bool emit_listxattr_query_mode = false;
bool emit_removexattr_query_mode = false;
bool emit_lgetxattr_query_mode = false;
...
bool emit_lsetxattr_query_mode = false;
bool emit_fchown_query_mode = false;
bool emit_chown_query_mode = false;
bool emit_lchown_query_mode = false;
bool emit_fchmodat_query_mode = false;
bool emit_faccessat_query_mode = false;
bool emit_faccessat2_query_mode = false;
bool emit_openat2_query_mode = false;
bool emit_statx_query_mode = false;
bool emit_statfs_query_mode = false;
...
bool emit_fcntl_dupfd_query_mode = false;
bool emit_fcntl_setfd_query_mode = false;
bool emit_fcntl_getown_query_mode = false;
bool emit_fcntl_getsig_query_mode = false;
bool emit_fcntl_setown_query_mode = false;
bool emit_fcntl_setfl_query_mode = false;
bool emit_fcntl_getlease_query_mode = false;
bool emit_fcntl_getseal_query_mode = false;
bool emit_fcntl_setlease_query_mode = false;
...
bool emit_fcntl_set_rw_hint_query_mode = false;
bool emit_fadvise_query_mode = false;
bool emit_syncfs_query_mode = false;
...
bool emit_ioprio_get_query_mode = false;
bool emit_madvise_query_mode = false;
bool emit_mprotect_query_mode = false;
bool emit_mremap_query_mode = false;
bool emit_mincore_query_mode = false;
bool emit_mlock2_query_mode = false;
...
bool emit_uselib_query_mode = false;
...
bool emit_readahead_query_mode = false;
bool emit_close_range_query_mode = false;
bool emit_getdents64_query_mode = false;
bool emit_openat_query_mode = false;
bool emit_mkdirat_query_mode = false;
...
bool emit_remap_file_pages_query_mode = false;
bool emit_fsync_query_mode = false;
bool emit_fdatasync_query_mode = false;
bool emit_readlinkat_query_mode = false;
bool emit_renameat2_query_mode = false;
bool emit_symlinkat_query_mode = false;
bool emit_renameat_query_mode = false;
...
bool emit_vserver_query_mode = false;
...
bool emit_rt_sigtimedwait_query_mode = false;
bool emit_rt_sigqueueinfo_query_mode = false;
bool emit_rt_tgsigqueueinfo_query_mode = false;
...
Program parse_main(std::string const& s) {
  ...
  static const std::regex argc_switch_five(R"(switch\s*\(\s*argc\s*\)\s*\{\s*case\s+([0-9]+)\s*:\s*return\s+([0-9]+)\s*;\s*case\s+([0-9]+)\s*:\s*return\s+([0-9]+)\s*;\s*case\s+([0-9]+)\s*:\s*return\s+([0-9]+)\s*;\s*case\s+([0-9]+)\s*:\s*return\s+([0-9]+)\s*;\s*case\s+([0-9]+)\s*:\s*return\s+([0-9]+)\s*;\s*default\s*:\s*return\s+([0-9]+)\s*;\s*\})");
  ...
  if(std::regex_search(s,r,enum_switch_implicit)) {
  ...
  else if(std::regex_search(body,r,argc_switch_five)) {
    p.switch_return=true; p.switch_two_cases=true; p.switch_case=std::stoi(r[1]); p.switch_case_status=std::stoi(r[2]);
    p.switch_case2=std::stoi(r[3]); p.switch_case2_status=std::stoi(r[4]); switch_case3=std::stoi(r[5]); switch_case3_status=std::stoi(r[6]); switch_case4=std::stoi(r[7]); switch_case4_status=std::stoi(r[8]); switch_case5=std::stoi(r[9]); switch_case5_status=std::stoi(r[10]); p.switch_default_status=std::stoi(r[11]);
  }
    ...
    p.switch_return=true; p.switch_two_cases=true; p.switch_case=std::stoi(r[1]); p.switch_case_status=std::stoi(r[2]);
    p.switch_case2=std::stoi(r[3]); p.switch_case2_status=std::stoi(r[4]); switch_case3=std::stoi(r[5]); switch_case3_status=std::stoi(r[6]); p.switch_default_status=std::stoi(r[7]);
  }
  ...
  emit_msgsnd_query_mode=std::regex_search(body,std::regex(R"re(\bmsgsnd_query\s*\(\s*\)\s*;)re"));
  emit_msgrcv_query_mode=std::regex_search(body,std::regex(R"re(\bmsgrcv_query\s*\(\s*\)\s*;)re"));
  emit_msgctl_query_mode=std::regex_search(body,std::regex(R"re(\bmsgctl_query\s*\(\s*\)\s*;)re"));
  emit_mq_open_query_mode=std::regex_search(body,std::regex(R"re(\bmq_open_query\s*\(\s*\)\s*;)re"));
  emit_mq_unlink_query_mode=std::regex_search(body,std::regex(R"re(\bmq_unlink_query\s*\(\s*\)\s*;)re"));
  ...
  emit_listxattr_query_mode=std::regex_search(body,std::regex(R"re(\blistxattr_query\s*\(\s*\)\s*;)re"));
  emit_removexattr_query_mode=std::regex_search(body,std::regex(R"re(\bremovexattr_query\s*\(\s*\)\s*;)re"));
  emit_lgetxattr_query_mode=std::regex_search(body,std::regex(R"re(\blgetxattr_query\s*\(\s*\)\s*;)re"));
  ...
  emit_lsetxattr_query_mode=std::regex_search(body,std::regex(R"re(\blsetxattr_query\s*\(\s*\)\s*;)re"));
  emit_fchown_query_mode=std::regex_search(body,std::regex(R"re(\bfchown_query\s*\(\s*\)\s*;)re"));
  emit_chown_query_mode=std::regex_search(body,std::regex(R"re(\bchown_query\s*\(\s*\)\s*;)re"));
  emit_lchown_query_mode=std::regex_search(body,std::regex(R"re(\blchown_query\s*\(\s*\)\s*;)re"));
  emit_fchmodat_query_mode=std::regex_search(body,std::regex(R"re(\bfchmodat_query\s*\(\s*\)\s*;)re"));
  emit_faccessat_query_mode=std::regex_search(body,std::regex(R"re(\bfaccessat_query\s*\(\s*\)\s*;)re"));
  emit_faccessat2_query_mode=std::regex_search(body,std::regex(R"re(\bfaccessat2_query\s*\(\s*\)\s*;)re"));
  emit_openat2_query_mode=std::regex_search(body,std::regex(R"re(\bopenat2_query\s*\(\s*\)\s*;)re"));
  emit_statx_query_mode=std::regex_search(body,std::regex(R"re(\bstatx_query\s*\(\s*\)\s*;)re"));
  emit_statfs_query_mode=std::regex_search(body,std::regex(R"re(\bstatfs_query\s*\(\s*\)\s*;)re"));
  ...
  emit_fcntl_dupfd_query_mode=std::regex_search(body,std::regex(R"re(\bfcntl_dupfd_query\s*\(\s*\)\s*;)re"));
  emit_fcntl_setfd_query_mode=std::regex_search(body,std::regex(R"re(\bfcntl_setfd_query\s*\(\s*\)\s*;)re"));
  emit_fcntl_getown_query_mode=std::regex_search(body,std::regex(R"re(\bfcntl_getown_query\s*\(\s*\)\s*;)re"));
  emit_fcntl_getsig_query_mode=std::regex_search(body,std::regex(R"re(\bfcntl_getsig_query\s*\(\s*\)\s*;)re"));
  emit_fcntl_setown_query_mode=std::regex_search(body,std::regex(R"re(\bfcntl_setown_query\s*\(\s*\)\s*;)re"));
  emit_fcntl_setfl_query_mode=std::regex_search(body,std::regex(R"re(\bfcntl_setfl_query\s*\(\s*\)\s*;)re"));
  emit_fcntl_getlease_query_mode=std::regex_search(body,std::regex(R"re(\bfcntl_getlease_query\s*\(\s*\)\s*;)re"));
  emit_fcntl_getseal_query_mode=std::regex_search(body,std::regex(R"re(\bfcntl_getseal_query\s*\(\s*\)\s*;)re"));
  emit_fcntl_setlease_query_mode=std::regex_search(body,std::regex(R"re(\bfcntl_setlease_query\s*\(\s*\)\s*;)re"));
  ...
  emit_fcntl_set_rw_hint_query_mode=std::regex_search(body,std::regex(R"re(\bfcntl_set_rw_hint_query\s*\(\s*\)\s*;)re"));
  emit_fadvise_query_mode=std::regex_search(body,std::regex(R"re(\bfadvise_query\s*\(\s*\)\s*;)re"));
  emit_syncfs_query_mode=std::regex_search(body,std::regex(R"re(\bsyncfs_query\s*\(\s*\)\s*;)re"));
  ...
  emit_ioprio_get_query_mode=std::regex_search(body,std::regex(R"re(\bioprio_get_query\s*\(\s*\)\s*;)re"));
  ...
  emit_mincore_query_mode=std::regex_search(body,std::regex(R"re(\bmincore_query\s*\(\s*\)\s*;)re"));
  emit_mlock2_query_mode=std::regex_search(body,std::regex(R"re(\bmlock2_query\s*\(\s*\)\s*;)re"));
  ...
  emit_uselib_query_mode=std::regex_search(body,std::regex(R"re(\buselib_query\s*\(\s*\)\s*;)re"));
  ...
  emit_readahead_query_mode=std::regex_search(body,std::regex(R"re(\breadahead_query\s*\(\s*\)\s*;)re"));
  emit_close_range_query_mode=std::regex_search(body,std::regex(R"re(\bclose_range_query\s*\(\s*\)\s*;)re"));
  emit_getdents64_query_mode=std::regex_search(body,std::regex(R"re(\bgetdents64_query\s*\(\s*\)\s*;)re"));
  emit_openat_query_mode=std::regex_search(body,std::regex(R"re(\bopenat_query\s*\(\s*\)\s*;)re"));
  emit_mkdirat_query_mode=std::regex_search(body,std::regex(R"re(\bmkdirat_query\s*\(\s*\)\s*;)re"));
  ...
  emit_remap_file_pages_query_mode=std::regex_search(body,std::regex(R"re(\bremap_file_pages_query\s*\(\s*\)\s*;)re"));
  emit_fsync_query_mode=std::regex_search(body,std::regex(R"re(\bfsync_query\s*\(\s*\)\s*;)re"));
  emit_fdatasync_query_mode=std::regex_search(body,std::regex(R"re(\bfdatasync_query\s*\(\s*\)\s*;)re"));
  ...
  emit_renameat_query_mode=std::regex_search(body,std::regex(R"re(\brenameat_query\s*\(\s*\)\s*;)re"));
  ...
  emit_vserver_query_mode=std::regex_search(body,std::regex(R"re(\bvserver_query\s*\(\s*\)\s*;)re"));
  ...
  emit_rt_sigtimedwait_query_mode=std::regex_search(body,std::regex(R"re(\brt_sigtimedwait_query\s*\(\s*\)\s*;)re"));
  emit_rt_sigqueueinfo_query_mode=std::regex_search(body,std::regex(R"re(\brt_sigqueueinfo_query\s*\(\s*\)\s*;)re"));
  emit_rt_tgsigqueueinfo_query_mode=std::regex_search(body,std::regex(R"re(\brt_tgsigqueueinfo_query\s*\(\s*\)\s*;)re"));
...
void emit_futex_wake_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $202, %eax\n  lea futex_wake_word(%rip), %rdi\n  mov $1, %esi\n  xor %edx, %edx\n  xor %r10d, %r10d\n  xor %r8d, %r8d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfutex_wake_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfutex_wake_done\n"
    <<".Lfutex_wake_fail:\n  mov $1, %edi\n.Lfutex_wake_done:\n"
    <<"  mov $60, %eax\n  syscall\n.bss\n.align 4\nfutex_wake_word:\n  .skip 4\n";
}
...
void emit_futex_cmp_requeue_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $202, %eax\n  lea futex_cmp_a(%rip), %rdi\n  mov $4, %esi\n  xor %edx, %edx\n  lea futex_cmp_b(%rip), %r10\n  xor %r8d, %r8d\n  xor %r9d, %r9d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfutex_cmp_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfutex_cmp_done\n"
    <<".Lfutex_cmp_fail:\n  mov $1, %edi\n.Lfutex_cmp_done:\n"
    <<"  mov $60, %eax\n  syscall\n.bss\n.align 4\nfutex_cmp_a:\n  .skip 4\nfutex_cmp_b:\n  .skip 4\n";
...
void emit_futex_lock_pi_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $202, %eax\n  lea futex_lock_pi_word(%rip), %rdi\n  mov $6, %esi\n  xor %edx, %edx\n  xor %r10d, %r10d\n  xor %r8d, %r8d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfutex_lock_pi_fail\n"
...
void emit_futex_wait_requeue_pi_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $202, %eax\n  lea futex_wait_requeue_pi_a(%rip), %rdi\n  mov $11, %esi\n  xor %edx, %edx\n  lea futex_wait_requeue_pi_ts(%rip), %r10\n  lea futex_wait_requeue_pi_b(%rip), %r8\n  xor %r9d, %r9d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfutex_wait_requeue_pi_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfutex_wait_requeue_pi_done\n"
    <<".Lfutex_wait_requeue_pi_fail:\n  mov $1, %edi\n.Lfutex_wait_requeue_pi_done:\n"
    <<"  mov $60, %eax\n  syscall\n.bss\n.align 4\nfutex_wait_requeue_pi_a:\n  .skip 4\nfutex_wait_requeue_pi_b:\n  .skip 4\n.align 8\nfutex_wait_requeue_pi_ts:\n  .skip 16\n";
}

void emit_futex_wait_bitset_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $202, %eax\n  lea futex_wait_bitset_word(%rip), %rdi\n  mov $9, %esi\n  xor %edx, %edx\n  lea futex_wait_bitset_ts(%rip), %r10\n  xor %r8d, %r8d\n  mov $-1, %r9d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfutex_wait_bitset_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfutex_wait_bitset_done\n"
    <<".Lfutex_wait_bitset_fail:\n  mov $1, %edi\n.Lfutex_wait_bitset_done:\n"
    <<"  mov $60, %eax\n  syscall\n.bss\n.align 4\nfutex_wait_bitset_word:\n  .skip 4\n.align 8\nfutex_wait_bitset_ts:\n  .skip 16\n";
}

void emit_futex_wake_bitset_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $202, %eax\n  lea futex_wake_bitset_word(%rip), %rdi\n  mov $10, %esi\n  xor %edx, %edx\n  xor %r10d, %r10d\n  mov $-1, %r8d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfutex_wake_bitset_fail\n"
...
void emit_futex_lock_pi2_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $202, %eax\n  lea futex_lock_pi2_word(%rip), %rdi\n  mov $13, %esi\n  xor %edx, %edx\n  lea futex_lock_pi2_ts(%rip), %r10\n  xor %r8d, %r8d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfutex_lock_pi2_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfutex_lock_pi2_done\n"
    <<".Lfutex_lock_pi2_fail:\n  mov $1, %edi\n.Lfutex_lock_pi2_done:\n"
    <<"  mov $60, %eax\n  syscall\n.bss\n.align 4\nfutex_lock_pi2_word:\n  .skip 4\n.align 8\nfutex_lock_pi2_ts:\n  .skip 16\n";
}

void emit_clock_settime_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $227, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lclock_settime_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lclock_settime_done\n"
    <<".Lclock_settime_fail:\n  mov $1, %edi\n.Lclock_settime_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_settimeofday_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $164, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  syscall\n"
...
void emit_msgget_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $68, %eax\n  mov $-1, %edi\n  xor %esi, %esi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lmsgget_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lmsgget_done\n"
...
void emit_shmget_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $29, %eax\n  mov $-1, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lshmget_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lshmget_done\n"
...
void emit_shmat_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $30, %eax\n  mov $-1, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  syscall\n"
    <<"  cmp $-4095, %rax\n  jae .Lshmat_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lshmat_done\n"
...
void emit_shmctl_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $31, %eax\n  mov $-1, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lshmctl_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lshmctl_done\n"
...
void emit_semctl_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $66, %eax\n  mov $-1, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  xor %r10d, %r10d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lsemctl_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lsemctl_done\n"
...
void emit_semop_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $65, %eax\n  mov $-1, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lsemop_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lsemop_done\n"
...
void emit_msgsnd_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $69, %eax\n  mov $-1, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  xor %r10d, %r10d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lmsgsnd_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lmsgsnd_done\n"
...
void emit_msgrcv_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $70, %eax\n  mov $-1, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  xor %r10d, %r10d\n  xor %r8d, %r8d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lmsgrcv_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lmsgrcv_done\n"
...
void emit_msgctl_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $71, %eax\n  mov $-1, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lmsgctl_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lmsgctl_done\n"
...
void emit_mq_open_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $240, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  xor %r10d, %r10d\n  xor %r8d, %r8d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lmq_open_fail\n"
    <<"  mov %eax, %edi\n  mov $3, %eax\n  syscall\n"
...
void emit_mq_unlink_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $241, %eax\n  xor %edi, %edi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lmq_unlink_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lmq_unlink_done\n"
...
void emit_mq_timedsend_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $242, %eax\n  mov $-1, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  xor %r10d, %r10d\n  xor %r8d, %r8d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lmq_timedsend_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lmq_timedsend_done\n"
    <<".Lmq_timedsend_fail:\n  mov $1, %edi\n.Lmq_timedsend_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_mq_timedreceive_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $243, %eax\n  mov $-1, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  xor %r10d, %r10d\n  xor %r8d, %r8d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lmq_timedreceive_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lmq_timedreceive_done\n"
    <<".Lmq_timedreceive_fail:\n  mov $1, %edi\n.Lmq_timedreceive_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_mq_notify_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $244, %eax\n  mov $-1, %edi\n  xor %esi, %esi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lmq_notify_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lmq_notify_done\n"
...
void emit_finit_module_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $313, %eax\n  mov $-1, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfinit_module_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfinit_module_done\n"
    <<".Lfinit_module_fail:\n  mov $1, %edi\n.Lfinit_module_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_delete_module_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $176, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Ldelete_module_fail\n"
    <<"  xor %edi, %edi\n  jmp .Ldelete_module_done\n"
    <<".Ldelete_module_fail:\n  mov $1, %edi\n.Ldelete_module_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_init_module_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $175, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  syscall\n"
...
void emit_uselib_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $134, %eax\n  xor %edi, %edi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Luselib_fail\n"
    <<"  xor %edi, %edi\n  jmp .Luselib_done\n"
...
void emit_quotactl_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $179, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  xor %r10d, %r10d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lquotactl_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lquotactl_done\n"
...
void emit_waitid_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $247, %eax\n  mov $1, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  mov $1, %r10d\n  xor %r8d, %r8d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lwaitid_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lwaitid_done\n"
...
void emit_capget_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $125, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lcapget_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lcapget_done\n"
...
void emit_readahead_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $187, %eax\n  mov $-1, %edi\n  xor %rsi, %rsi\n  xor %edx, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lreadahead_query_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lreadahead_query_done\n"
    <<".Lreadahead_query_fail:\n  mov $1, %edi\n.Lreadahead_query_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_close_range_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $436, %eax\n  mov $100, %edi\n  mov $99, %esi\n  xor %edx, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lclose_range_query_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lclose_range_query_done\n"
    <<".Lclose_range_query_fail:\n  mov $1, %edi\n.Lclose_range_query_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_getdents64_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $217, %eax\n  mov $-1, %edi\n  xor %rsi, %rsi\n  xor %edx, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lgetdents64_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lgetdents64_done\n"
    <<".Lgetdents64_fail:\n  mov $1, %edi\n.Lgetdents64_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_openat_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $257, %eax\n  mov $-100, %edi\n  xor %rsi, %rsi\n  xor %edx, %edx\n  xor %r10d, %r10d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lopenat_query_fail\n"
    <<"  mov %eax, %edi\n  mov $3, %eax\n  syscall\n  xor %edi, %edi\n  jmp .Lopenat_query_done\n"
    <<".Lopenat_query_fail:\n  mov $1, %edi\n.Lopenat_query_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_mkdirat_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $258, %eax\n  mov $-100, %edi\n  xor %rsi, %rsi\n  xor %edx, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lmkdirat_query_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lmkdirat_query_done\n"
    <<".Lmkdirat_query_fail:\n  mov $1, %edi\n.Lmkdirat_query_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_unlinkat_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $263, %eax\n  mov $-100, %edi\n  xor %rsi, %rsi\n  xor %edx, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lunlinkat_query_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lunlinkat_query_done\n"
    <<".Lunlinkat_query_fail:\n  mov $1, %edi\n.Lunlinkat_query_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_newfstatat_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $262, %eax\n  mov $-100, %edi\n  xor %rsi, %rsi\n  xor %rdx, %rdx\n  xor %r10d, %r10d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lnewfstatat_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lnewfstatat_done\n"
    <<".Lnewfstatat_fail:\n  mov $1, %edi\n.Lnewfstatat_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_fchownat_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $260, %eax\n  mov $-100, %edi\n  xor %rsi, %rsi\n  xor %edx, %edx\n  xor %r10d, %r10d\n  xor %r8d, %r8d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfchownat_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfchownat_done\n"
...
void emit_eventfd2_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $290, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Leventfd2_fail\n"
    <<"  mov %eax, %edi\n  mov $3, %eax\n  syscall\n  xor %edi, %edi\n  jmp .Leventfd2_done\n"
...
void emit_dup3_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $292, %eax\n  mov $-1, %edi\n  mov $100, %esi\n  xor %edx, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Ldup3_fail\n"
    <<"  mov %eax, %edi\n  mov $3, %eax\n  syscall\n  xor %edi, %edi\n  jmp .Ldup3_done\n"
...
void emit_signalfd_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $282, %eax\n  mov $-1, %edi\n  xor %rsi, %rsi\n  xor %edx, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lsignalfd_query_fail\n"
    <<"  mov %eax, %edi\n  mov $3, %eax\n  syscall\n  xor %edi, %edi\n  jmp .Lsignalfd_query_done\n"
    <<".Lsignalfd_query_fail:\n  mov $1, %edi\n.Lsignalfd_query_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_mmap_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $9, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  mov $3, %r10d\n  mov $-1, %r8d\n  xor %r9d, %r9d\n  syscall\n"
    <<"  test %rax, %rax\n  js .Lmmap_fail\n"
    <<"  mov %rax, %rdi\n  xor %esi, %esi\n  mov $11, %eax\n  syscall\n  xor %edi, %edi\n  jmp .Lmmap_done\n"
...
void emit_memfd_create_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $319, %eax\n  lea memfd_create_query_name(%rip), %rdi\n  xor %esi, %esi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lmemfd_create_query_fail\n"
    <<"  mov %eax, %edi\n  mov $3, %eax\n  syscall\n  xor %edi, %edi\n  jmp .Lmemfd_create_query_done\n"
...
void emit_remap_file_pages_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $216, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  xor %r10d, %r10d\n  xor %r8d, %r8d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lremap_file_pages_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lremap_file_pages_done\n"
    <<".Lremap_file_pages_fail:\n  mov $1, %edi\n.Lremap_file_pages_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_fsync_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $74, %eax\n  mov $-1, %edi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfsync_query_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfsync_query_done\n"
    <<".Lfsync_query_fail:\n  mov $1, %edi\n.Lfsync_query_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_fdatasync_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $75, %eax\n  mov $-1, %edi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfdatasync_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfdatasync_done\n"
...
void emit_renameat2_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $316, %eax\n  mov $-100, %edi\n  xor %rsi, %rsi\n  mov $-100, %edx\n  xor %r10d, %r10d\n  xor %r8d, %r8d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lrenameat2_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lrenameat2_done\n"
...
void emit_symlinkat_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $266, %eax\n  xor %edi, %edi\n  mov $-100, %esi\n  xor %rdx, %rdx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lsymlinkat_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lsymlinkat_done\n"
...
void emit_renameat_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $264, %eax\n  mov $-100, %edi\n  xor %rsi, %rsi\n  mov $-100, %edx\n  xor %r10d, %r10d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lrenameat_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lrenameat_done\n"
...
void emit_fstatat_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $262, %eax\n  mov $-100, %edi\n  xor %rsi, %rsi\n  xor %rdx, %rdx\n  xor %r10d, %r10d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfstatat_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfstatat_done\n"
...
void emit_mknodat_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $259, %eax\n  mov $-100, %edi\n  xor %rsi, %rsi\n  xor %edx, %edx\n  xor %r10d, %r10d\n  xor %r8d, %r8d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lmknodat_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lmknodat_done\n"
...
void emit_futimesat_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $261, %eax\n  mov $-100, %edi\n  xor %rsi, %rsi\n  xor %rdx, %rdx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfutimesat_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfutimesat_done\n"
...
void emit_pwritev2_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $328, %eax\n  mov $-1, %edi\n  xor %rsi, %rsi\n  xor %edx, %edx\n  xor %r10d, %r10d\n  xor %r8d, %r8d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lpwritev2_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lpwritev2_done\n"
...
void emit_readv_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $19, %eax\n  mov $-1, %edi\n  xor %rsi, %rsi\n  xor %edx, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lreadv_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lreadv_done\n"
...
void emit_preadv_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $295, %eax\n  mov $-1, %edi\n  xor %rsi, %rsi\n  xor %edx, %edx\n  xor %r10d, %r10d\n  xor %r8d, %r8d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lpreadv_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lpreadv_done\n"
...
void emit_pwritev_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $296, %eax\n  mov $-1, %edi\n  xor %rsi, %rsi\n  xor %edx, %edx\n  xor %r10d, %r10d\n  xor %r8d, %r8d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lpwritev_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lpwritev_done\n"
...
void emit_sched_setscheduler_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $144, %eax\n  mov $-1, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lsched_setscheduler_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lsched_setscheduler_done\n"
    <<".Lsched_setscheduler_fail:\n  mov $1, %edi\n"
...
void emit_get_thread_area_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $211, %eax\n  mov $-1, %rdi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lget_thread_area_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lget_thread_area_done\n"
    <<".Lget_thread_area_fail:\n  mov $1, %edi\n.Lget_thread_area_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}
...
void emit_nfsservctl_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $180, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lnfsservctl_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lnfsservctl_done\n"
    <<".Lnfsservctl_fail:\n  mov $1, %edi\n.Lnfsservctl_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_vserver_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $236, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  xor %r10d, %r10d\n  xor %r8d, %r8d\n  xor %r9d, %r9d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lvserver_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lvserver_done\n"
...
void emit_sigaltstack_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $131, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lsigaltstack_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lsigaltstack_done\n"
    <<".Lsigaltstack_fail:\n  mov $1, %edi\n.Lsigaltstack_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}
...
void emit_rt_sigtimedwait_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $128, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  mov $8, %r10d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lrt_sigtimedwait_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lrt_sigtimedwait_done\n"
    <<".Lrt_sigtimedwait_fail:\n  mov $1, %edi\n.Lrt_sigtimedwait_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_rt_sigqueueinfo_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $129, %eax\n  mov $-1, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lrt_sigqueueinfo_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lrt_sigqueueinfo_done\n"
    <<".Lrt_sigqueueinfo_fail:\n  mov $1, %edi\n.Lrt_sigqueueinfo_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_rt_tgsigqueueinfo_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $297, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lrt_tgsigqueueinfo_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lrt_tgsigqueueinfo_done\n"
    <<".Lrt_tgsigqueueinfo_fail:\n  mov $1, %edi\n.Lrt_tgsigqueueinfo_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_set_robust_list_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $273, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lsetrobust_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lsetrobust_done\n"
...
void emit_rt_sigprocmask_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $14, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  mov $8, %r10d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lrt_sigprocmask_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lrt_sigprocmask_done\n"
    <<".Lrt_sigprocmask_fail:\n  mov $1, %edi\n.Lrt_sigprocmask_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_rt_sigaction_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $13, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  mov $8, %r10d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lrt_sigaction_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lrt_sigaction_done\n"
    <<".Lrt_sigaction_fail:\n  mov $1, %edi\n.Lrt_sigaction_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}
...
void emit_restart_syscall_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $219, %eax\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lrestart_syscall_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lrestart_syscall_done\n"
    <<".Lrestart_syscall_fail:\n  mov $1, %edi\n.Lrestart_syscall_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}
...
void emit_modify_ldt_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $154, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lmodify_ldt_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lmodify_ldt_done\n"
    <<".Lmodify_ldt_fail:\n  mov $1, %edi\n.Lmodify_ldt_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_io_pgetevents_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $333, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  xor %r10d, %r10d\n  xor %r8d, %r8d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Liopgetevents_fail\n"
    <<"  xor %edi, %edi\n  jmp .Liopgetevents_done\n"
    <<".Liopgetevents_fail:\n  mov $1, %edi\n.Liopgetevents_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}
...
void emit_kexec_file_load_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $320, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  xor %r10d, %r10d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lkexec_file_load_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lkexec_file_load_done\n"
    <<".Lkexec_file_load_fail:\n  mov $1, %edi\n.Lkexec_file_load_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_syslog_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $103, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lsyslog_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lsyslog_done\n"
...
void emit_setpriority_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $141, %eax\n  xor %edi, %edi\n  mov $-1, %esi\n  xor %edx, %edx\n  syscall\n"
...
void emit_listxattr_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $196, %eax\n  lea listxattr_path(%rip), %rdi\n  lea listxattr_value(%rip), %rsi\n  mov $64, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Llistxattr_fail\n"
    <<"  xor %edi, %edi\n  jmp .Llistxattr_done\n"
    <<".Llistxattr_fail:\n  mov $1, %edi\n.Llistxattr_done:\n  mov $60, %eax\n  syscall\n"
    <<".section .rodata\nlistxattr_path:\n  .asciz \".\"\n"
...
void emit_removexattr_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $197, %eax\n  lea removexattr_path(%rip), %rdi\n  lea removexattr_name(%rip), %rsi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lremovexattr_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lremovexattr_done\n"
    <<".Lremovexattr_fail:\n  mov $1, %edi\n.Lremovexattr_done:\n  mov $60, %eax\n  syscall\n"
    <<".section .rodata\nremovexattr_path:\n  .asciz \".\"\nremovexattr_name:\n  .asciz \"user.selfapp\"\n";
}

void emit_lgetxattr_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $192, %eax\n  lea lgetxattr_path(%rip), %rdi\n  lea lgetxattr_name(%rip), %rsi\n  lea lgetxattr_value(%rip), %rdx\n  mov $16, %r10d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Llgetxattr_fail\n"
    <<"  xor %edi, %edi\n  jmp .Llgetxattr_done\n"
    <<".Llgetxattr_fail:\n  mov $1, %edi\n.Llgetxattr_done:\n  mov $60, %eax\n  syscall\n"
    <<".section .rodata\nlgetxattr_path:\n  .asciz \".\"\nlgetxattr_name:\n  .asciz \"user.selfapp\"\n"
...
void emit_llistxattr_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $195, %eax\n  lea llistxattr_path(%rip), %rdi\n  lea llistxattr_value(%rip), %rsi\n  mov $64, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lllistxattr_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lllistxattr_done\n"
    <<".Lllistxattr_fail:\n  mov $1, %edi\n.Lllistxattr_done:\n  mov $60, %eax\n  syscall\n"
    <<".section .rodata\nllistxattr_path:\n  .asciz \".\"\n"
    <<".bss\n.align 8\nllistxattr_value:\n  .skip 64\n";
}

void emit_fgetxattr_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $193, %eax\n  mov $1, %edi\n  lea fgetxattr_name(%rip), %rsi\n  lea fgetxattr_value(%rip), %rdx\n  mov $16, %r10d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfgetxattr_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfgetxattr_done\n"
    <<".Lfgetxattr_fail:\n  mov $1, %edi\n.Lfgetxattr_done:\n  mov $60, %eax\n  syscall\n"
    <<".section .rodata\nfgetxattr_name:\n  .asciz \"user.selfapp\"\n"
...
void emit_flistxattr_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $196, %eax\n  mov $1, %edi\n  lea flistxattr_value(%rip), %rsi\n  mov $64, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lflistxattr_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lflistxattr_done\n"
    <<".Lflistxattr_fail:\n  mov $1, %edi\n.Lflistxattr_done:\n  mov $60, %eax\n  syscall\n"
    <<".bss\n.align 8\nflistxattr_value:\n  .skip 64\n";
...
void emit_fremovexattr_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $199, %eax\n  mov $1, %edi\n  lea fremovexattr_name(%rip), %rsi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfremovexattr_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfremovexattr_done\n"
    <<".Lfremovexattr_fail:\n  mov $1, %edi\n.Lfremovexattr_done:\n  mov $60, %eax\n  syscall\n"
    <<".section .rodata\nfremovexattr_name:\n  .asciz \"user.selfapp\"\n";
}
...
void emit_lsetxattr_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $189, %eax\n  lea lsetxattr_path(%rip), %rdi\n  lea lsetxattr_name(%rip), %rsi\n  lea lsetxattr_value(%rip), %rdx\n  mov $1, %r10d\n  mov $1, %r8d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Llsetxattr_fail\n"
    <<"  xor %edi, %edi\n  jmp .Llsetxattr_done\n"
    <<".Llsetxattr_fail:\n  mov $1, %edi\n.Llsetxattr_done:\n  mov $60, %eax\n  syscall\n"
    <<".section .rodata\nlsetxattr_path:\n  .asciz \"/selfapp-no-such-path\"\nlsetxattr_name:\n  .asciz \"user.selfapp\"\nlsetxattr_value:\n  .byte 0\n";
...
void emit_fchown_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $93, %eax\n  mov $1, %edi\n  mov $-1, %esi\n  mov $-1, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfchown_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfchown_done\n"
...
void emit_chown_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $92, %eax\n  lea chown_path(%rip), %rdi\n  mov $-1, %esi\n  mov $-1, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lchown_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lchown_done\n"
    <<".Lchown_fail:\n  mov $1, %edi\n.Lchown_done:\n  mov $60, %eax\n  syscall\n"
    <<".section .rodata\nchown_path:\n  .asciz \"/selfapp-no-such-path\"\n";
...
void emit_lchown_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $94, %eax\n  lea lchown_path(%rip), %rdi\n  mov $-1, %esi\n  mov $-1, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Llchown_fail\n"
    <<"  xor %edi, %edi\n  jmp .Llchown_done\n"
    <<".Llchown_fail:\n  mov $1, %edi\n.Llchown_done:\n  mov $60, %eax\n  syscall\n"
    <<".section .rodata\nlchown_path:\n  .asciz \"/selfapp-no-such-path\"\n";
...
void emit_fchmodat_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $268, %eax\n  mov $-100, %edi\n  lea fchmodat_path(%rip), %rsi\n  xor %edx, %edx\n  xor %r10d, %r10d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfchmodat_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfchmodat_done\n"
    <<".Lfchmodat_fail:\n  mov $1, %edi\n.Lfchmodat_done:\n  mov $60, %eax\n  syscall\n"
    <<".section .rodata\nfchmodat_path:\n  .asciz \"/selfapp-no-such-path\"\n";
...
void emit_faccessat_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $269, %eax\n  mov $-100, %edi\n  lea faccessat_path(%rip), %rsi\n  xor %edx, %edx\n  xor %r10d, %r10d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfaccessat_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfaccessat_done\n"
    <<".Lfaccessat_fail:\n  mov $1, %edi\n.Lfaccessat_done:\n  mov $60, %eax\n  syscall\n"
    <<".section .rodata\nfaccessat_path:\n  .asciz \"/selfapp-no-such-path\"\n";
...
void emit_faccessat2_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $439, %eax\n  mov $-100, %edi\n  lea faccessat2_path(%rip), %rsi\n  xor %edx, %edx\n  xor %r10d, %r10d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfaccessat2_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfaccessat2_done\n"
...
void emit_openat2_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $437, %eax\n  mov $-100, %edi\n  lea openat2_path(%rip), %rsi\n  lea openat2_how(%rip), %rdx\n  mov $24, %r10d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lopenat2_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lopenat2_done\n"
...
void emit_statx_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $332, %eax\n  mov $-100, %edi\n  lea statx_path(%rip), %rsi\n  xor %edx, %edx\n  mov $2047, %r10d\n  lea statx_value(%rip), %r8\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lstatx_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lstatx_done\n"
    <<".Lstatx_fail:\n  mov $1, %edi\n.Lstatx_done:\n  mov $60, %eax\n  syscall\n"
    <<".section .rodata\nstatx_path:\n  .asciz \".\"\n"
...
void emit_statfs_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $137, %eax\n  lea statfs_path(%rip), %rdi\n  lea statfs_value(%rip), %rsi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lstatfs_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lstatfs_done\n"
    <<".Lstatfs_fail:\n  mov $1, %edi\n.Lstatfs_done:\n  mov $60, %eax\n  syscall\n"
    <<".section .rodata\nstatfs_path:\n  .asciz \".\"\n"
...
void emit_fstatfs_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $138, %eax\n  mov $1, %edi\n  lea fstatfs_value(%rip), %rsi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfstatfs_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfstatfs_done\n"
    <<".Lfstatfs_fail:\n  mov $1, %edi\n.Lfstatfs_done:\n  mov $60, %eax\n  syscall\n"
    <<".bss\n.align 8\nfstatfs_value:\n  .skip 112\n";
...
void emit_pselect6_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $270, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  xor %r10d, %r10d\n  lea pselect6_timeout(%rip), %r8\n  xor %r9d, %r9d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lpselect6_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lpselect6_done\n"
...
void emit_ppoll_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $271, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  lea ppoll_timeout(%rip), %rdx\n  xor %r10d, %r10d\n  xor %r8d, %r8d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lppoll_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lppoll_done\n"
...
void emit_poll_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $7, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lpoll_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lpoll_done\n"
...
void emit_clock_adjtime_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $305, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lclock_adjtime_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lclock_adjtime_done\n"
    <<".Lclock_adjtime_fail:\n  mov $1, %edi\n.Lclock_adjtime_done:\n  mov $60, %eax\n  syscall\n";
}
...
void emit_fcntl_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $72, %eax\n  mov $1, %edi\n  mov $1, %esi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfcntl_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfcntl_done\n"
...
void emit_fcntl_dupfd_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $72, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfcntl_dupfd_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfcntl_dupfd_done\n"
    <<".Lfcntl_dupfd_fail:\n  mov $1, %edi\n.Lfcntl_dupfd_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_fcntl_setfd_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $72, %eax\n  mov $1, %edi\n  mov $2, %esi\n  xor %edx, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfcntl_setfd_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfcntl_setfd_done\n"
    <<".Lfcntl_setfd_fail:\n  mov $1, %edi\n.Lfcntl_setfd_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_fcntl_getown_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $72, %eax\n  mov $1, %edi\n  mov $9, %esi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfcntl_getown_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfcntl_getown_done\n"
    <<".Lfcntl_getown_fail:\n  mov $1, %edi\n.Lfcntl_getown_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_fcntl_getsig_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $72, %eax\n  mov $1, %edi\n  mov $13, %esi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfcntl_getsig_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfcntl_getsig_done\n"
    <<".Lfcntl_getsig_fail:\n  mov $1, %edi\n.Lfcntl_getsig_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_fcntl_setown_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $72, %eax\n  mov $1, %edi\n  mov $8, %esi\n  xor %edx, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfcntl_setown_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfcntl_setown_done\n"
    <<".Lfcntl_setown_fail:\n  mov $1, %edi\n.Lfcntl_setown_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_fcntl_setfl_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $72, %eax\n  mov $1, %edi\n  mov $4, %esi\n  xor %edx, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfcntl_setfl_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfcntl_setfl_done\n"
    <<".Lfcntl_setfl_fail:\n  mov $1, %edi\n.Lfcntl_setfl_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_fcntl_getlease_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $72, %eax\n  mov $1, %edi\n  mov $1025, %esi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfcntl_getlease_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfcntl_getlease_done\n"
    <<".Lfcntl_getlease_fail:\n  mov $1, %edi\n.Lfcntl_getlease_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_fcntl_getseal_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $72, %eax\n  mov $1, %edi\n  mov $1034, %esi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfcntl_getseal_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfcntl_getseal_done\n"
    <<".Lfcntl_getseal_fail:\n  mov $1, %edi\n.Lfcntl_getseal_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_fcntl_setlease_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $72, %eax\n  mov $1, %edi\n  mov $1024, %esi\n  xor %edx, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfcntl_setlease_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfcntl_setlease_done\n"
    <<".Lfcntl_setlease_fail:\n  mov $1, %edi\n.Lfcntl_setlease_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_fcntl_setpipe_sz_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $22, %eax\n  lea fcntl_setpipe_pair(%rip), %rdi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfsetpipe_fail\n"
    <<"  mov fcntl_setpipe_pair(%rip), %edi\n  mov $72, %eax\n  mov $1031, %esi\n  mov $4096, %edx\n  syscall\n"
    <<"  mov fcntl_setpipe_pair(%rip), %edi\n  mov $3, %eax\n  syscall\n"
    <<"  mov fcntl_setpipe_pair+4(%rip), %edi\n  mov $3, %eax\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfsetpipe_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfsetpipe_done\n"
    <<".Lfsetpipe_fail:\n  mov $1, %edi\n.Lfsetpipe_done:\n"
    <<"  mov $60, %eax\n  syscall\n.bss\n.align 8\nfcntl_setpipe_pair:\n  .skip 8\n";
...
void emit_fcntl_dupfd_cloexec_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $72, %eax\n  xor %edi, %edi\n  mov $1030, %esi\n  xor %edx, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfcntl_dupfd_ce_fail\n"
    <<"  mov %eax, %edi\n  mov $3, %eax\n  syscall\n"
    <<"  xor %edi, %edi\n  jmp .Lfcntl_dupfd_ce_done\n"
    <<".Lfcntl_dupfd_ce_fail:\n  mov $1, %edi\n.Lfcntl_dupfd_ce_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_fcntl_add_seals_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $319, %eax\n  lea fcntl_seal_name(%rip), %rdi\n  mov $2, %esi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfaddseal_fail\n"
    <<"  mov %eax, %r12d\n  mov $72, %eax\n  mov %r12d, %edi\n  mov $1033, %esi\n  mov $1, %edx\n  syscall\n"
    <<"  mov %r12d, %edi\n  mov $3, %eax\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfaddseal_fail\n"
...
void emit_fcntl_set_rw_hint_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $319, %eax\n  lea fcntl_set_hint_name(%rip), %rdi\n  xor %esi, %esi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfsethint_fail\n"
    <<"  mov %eax, %r12d\n  movq $1, fcntl_set_hint_value(%rip)\n  mov $72, %eax\n  mov %r12d, %edi\n  mov $1036, %esi\n  lea fcntl_set_hint_value(%rip), %rdx\n  syscall\n"
    <<"  mov %r12d, %edi\n  mov $3, %eax\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfsethint_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfsethint_done\n"
    <<".Lfsethint_fail:\n  mov $1, %edi\n.Lfsethint_done:\n"
    <<"  mov $60, %eax\n  syscall\n.section .rodata\nfcntl_set_hint_name:\n  .asciz \"selfapp-set-hint\"\n.bss\n.align 8\nfcntl_set_hint_value:\n  .skip 8\n";
}

void emit_fadvise_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $221, %eax\n  mov $1, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  xor %r10d, %r10d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lfadvise_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lfadvise_done\n"
...
void emit_syncfs_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $306, %eax\n  mov $1, %edi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lsyncfs_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lsyncfs_done\n"
...
void emit_mlock_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $149, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lmlock_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lmlock_done\n"
...
void emit_munlock_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $150, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lmunlock_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lmunlock_done\n"
...
void emit_ioprio_get_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $252, %eax\n  mov $1, %edi\n  xor %esi, %esi\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lioprio_get_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lioprio_get_done\n"
    <<".Lioprio_get_fail:\n  mov $1, %edi\n.Lioprio_get_done:\n"
    <<"  mov $60, %eax\n  syscall\n";
}

void emit_madvise_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $28, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lmadvise_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lmadvise_done\n"
...
void emit_mprotect_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $10, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lmprotect_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lmprotect_done\n"
...
void emit_mremap_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $25, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  xor %r10d, %r10d\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lmremap_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lmremap_done\n"
...
void emit_mincore_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $27, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lmincore_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lmincore_done\n"
...
void emit_mlock2_query(Program const&) {
  std::cout<<".text\n.globl _start\n_start:\n"
    <<"  mov $325, %eax\n  xor %edi, %edi\n  xor %esi, %esi\n  xor %edx, %edx\n  syscall\n"
    <<"  test %eax, %eax\n  js .Lmlock2_fail\n"
    <<"  xor %edi, %edi\n  jmp .Lmlock2_done\n"
...
int main(int argc,char **argv) {
  ...
  try {
    ...
    if(csubset::emit_rt_sigtimedwait_query_mode) { csubset::emit_rt_sigtimedwait_query(program); return 0; }
    if(csubset::emit_rt_sigqueueinfo_query_mode) { csubset::emit_rt_sigqueueinfo_query(program); return 0; }
    if(csubset::emit_rt_tgsigqueueinfo_query_mode) { csubset::emit_rt_tgsigqueueinfo_query(program); return 0; }
    ...
    if(csubset::emit_msgsnd_query_mode) { csubset::emit_msgsnd_query(program); return 0; }
    if(csubset::emit_msgrcv_query_mode) { csubset::emit_msgrcv_query(program); return 0; }
    if(csubset::emit_msgctl_query_mode) { csubset::emit_msgctl_query(program); return 0; }
    if(csubset::emit_mq_open_query_mode) { csubset::emit_mq_open_query(program); return 0; }
    if(csubset::emit_mq_unlink_query_mode) { csubset::emit_mq_unlink_query(program); return 0; }
    ...
    if(csubset::emit_listxattr_query_mode) { csubset::emit_listxattr_query(program); return 0; }
    if(csubset::emit_removexattr_query_mode) { csubset::emit_removexattr_query(program); return 0; }
    if(csubset::emit_lgetxattr_query_mode) { csubset::emit_lgetxattr_query(program); return 0; }
    ...
    if(csubset::emit_lsetxattr_query_mode) { csubset::emit_lsetxattr_query(program); return 0; }
    if(csubset::emit_fchown_query_mode) { csubset::emit_fchown_query(program); return 0; }
    if(csubset::emit_chown_query_mode) { csubset::emit_chown_query(program); return 0; }
    if(csubset::emit_lchown_query_mode) { csubset::emit_lchown_query(program); return 0; }
    if(csubset::emit_fchmodat_query_mode) { csubset::emit_fchmodat_query(program); return 0; }
    if(csubset::emit_faccessat_query_mode) { csubset::emit_faccessat_query(program); return 0; }
    if(csubset::emit_faccessat2_query_mode) { csubset::emit_faccessat2_query(program); return 0; }
    if(csubset::emit_openat2_query_mode) { csubset::emit_openat2_query(program); return 0; }
    if(csubset::emit_statx_query_mode) { csubset::emit_statx_query(program); return 0; }
    if(csubset::emit_statfs_query_mode) { csubset::emit_statfs_query(program); return 0; }
    ...
    if(csubset::emit_fcntl_dupfd_query_mode) { csubset::emit_fcntl_dupfd_query(program); return 0; }
    if(csubset::emit_fcntl_setfd_query_mode) { csubset::emit_fcntl_setfd_query(program); return 0; }
    if(csubset::emit_fcntl_getown_query_mode) { csubset::emit_fcntl_getown_query(program); return 0; }
    if(csubset::emit_fcntl_getsig_query_mode) { csubset::emit_fcntl_getsig_query(program); return 0; }
    if(csubset::emit_fcntl_setown_query_mode) { csubset::emit_fcntl_setown_query(program); return 0; }
    if(csubset::emit_fcntl_setfl_query_mode) { csubset::emit_fcntl_setfl_query(program); return 0; }
    if(csubset::emit_fcntl_getlease_query_mode) { csubset::emit_fcntl_getlease_query(program); return 0; }
    if(csubset::emit_fcntl_getseal_query_mode) { csubset::emit_fcntl_getseal_query(program); return 0; }
    if(csubset::emit_fcntl_setlease_query_mode) { csubset::emit_fcntl_setlease_query(program); return 0; }
    ...
    if(csubset::emit_fcntl_set_rw_hint_query_mode) { csubset::emit_fcntl_set_rw_hint_query(program); return 0; }
    if(csubset::emit_fadvise_query_mode) { csubset::emit_fadvise_query(program); return 0; }
    if(csubset::emit_syncfs_query_mode) { csubset::emit_syncfs_query(program); return 0; }
    if(csubset::emit_mlock_query_mode) { csubset::emit_mlock_query(program); return 0; }
    ...
    if(csubset::emit_ioprio_get_query_mode) { csubset::emit_ioprio_get_query(program); return 0; }
    ...
    if(csubset::emit_mincore_query_mode) { csubset::emit_mincore_query(program); return 0; }
    ...
    if(csubset::emit_uselib_query_mode) { csubset::emit_uselib_query(program); return 0; }
    ...
    if(csubset::emit_readahead_query_mode) { csubset::emit_readahead_query(program); return 0; }
    if(csubset::emit_close_range_query_mode) { csubset::emit_close_range_query(program); return 0; }
    if(csubset::emit_getdents64_query_mode) { csubset::emit_getdents64_query(program); return 0; }
    if(csubset::emit_openat_query_mode) { csubset::emit_openat_query(program); return 0; }
    if(csubset::emit_mkdirat_query_mode) { csubset::emit_mkdirat_query(program); return 0; }
    ...
    if(csubset::emit_remap_file_pages_query_mode) { csubset::emit_remap_file_pages_query(program); return 0; }
    if(csubset::emit_fsync_query_mode) { csubset::emit_fsync_query(program); return 0; }
    if(csubset::emit_fdatasync_query_mode) { csubset::emit_fdatasync_query(program); return 0; }
    ...
    if(csubset::emit_preadv_query_mode) { csubset::emit_preadv_query(program); return 0; }
    if(csubset::emit_pwritev_query_mode) { csubset::emit_pwritev_query(program); return 0; }
    ...
    if(csubset::emit_renameat_query_mode) { csubset::emit_renameat_query(program); return 0; }
    ...
    if(csubset::emit_vserver_query_mode) { csubset::emit_vserver_query(program); return 0; }
    ...
    if(program.pointer_equal) std::cout
             <<"  mov $"<<program.then_status<<", %edi\n  jmp .Lexit\n";
    if(program.switch_return && csubset::switch_case5 >= 0) {
      std::cout<<"  mov (%rsp), %rdi\n"
               <<"  cmp $"<<program.switch_case<<", %rdi\n  jne .Lswitch_case2\n"
               <<"  mov $"<<program.switch_case_status<<", %edi\n  jmp .Lexit\n.Lswitch_case2:\n"
               <<"  cmp $"<<program.switch_case2<<", %rdi\n  jne .Lswitch_case3\n"
               <<"  mov $"<<program.switch_case2_status<<", %edi\n  jmp .Lexit\n.Lswitch_case3:\n"
               <<"  cmp $"<<csubset::switch_case3<<", %rdi\n  jne .Lswitch_case4\n"
               <<"  mov $"<<csubset::switch_case3_status<<", %edi\n  jmp .Lexit\n.Lswitch_case4:\n"
               <<"  cmp $"<<csubset::switch_case4<<", %rdi\n  jne .Lswitch_case5\n"
               <<"  mov $"<<csubset::switch_case4_status<<", %edi\n  jmp .Lexit\n.Lswitch_case5:\n"
               <<"  cmp $"<<csubset::switch_case5<<", %rdi\n  jne .Lswitch_default\n"
               <<"  mov $"<<csubset::switch_case5_status<<", %edi\n  jmp .Lexit\n.Lswitch_default:\n"
               <<"  mov $"<<program.switch_default_status<<", %edi\n  jmp .Lexit\n";
    }
    if(program.switch_return && csubset::switch_case5 < 0) std::cout
             <<"  mov (%rsp), %rdi\n  cmp $"<<program.switch_case<<", %rdi\n"
             <<"  jne .Lswitch_case2\n  mov $"<<program.switch_case_status<<", %edi\n  jmp .Lexit\n.Lswitch_case2:\n"
