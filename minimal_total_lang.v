...
(* The next planned layer is a typed de Bruijn environment and [let].  It is
   deliberately kept outside this first verified kernel milestone until its
   dependent lookup equality is stated explicitly. *)
